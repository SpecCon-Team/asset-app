import{u as Q,r,h as p,j as e,Q as l,P as i,D as R}from"./index-DvknDCE2.js";import{showError as c,showSuccess as u}from"./sweetalert-BCvQYi5m.js";import{A}from"./arrow-left-BoqIkaf7.js";import{C as S}from"./circle-check-big-C7c-8Hq7.js";function D(){const b=Q(),[x,m]=r.useState(!1),[y,f]=r.useState([]),[d,g]=r.useState(""),[s,h]=r.useState(null);r.useEffect(()=>{j()},[]);const j=async()=>{try{const a=await p().get("/assets"),n=Array.isArray(a.data)?a.data:a.data.assets||[];f(n)}catch(t){console.error("Failed to fetch assets:",t),await c("Error","Failed to load assets")}},w=async t=>{var a,n;if(t.preventDefault(),!d){await c("Error","Please select an asset");return}try{m(!0);const C=await p().post("/checkout/qr/generate",{assetId:d});h(C.data.qrCode),await u("Success!","QR code generated successfully",1500)}catch(o){console.error("Failed to generate QR code:",o),await c("Error",((n=(a=o.response)==null?void 0:a.data)==null?void 0:n.message)||"Failed to generate QR code")}finally{m(!1)}},k=()=>{if(!s)return;const t=document.createElement("a");t.href=s.qrCodeUrl,t.download=`QR_${s.asset.asset_code}.png`,document.body.appendChild(t),t.click(),document.body.removeChild(t),u("Downloaded!","QR code image downloaded",1500)},N=()=>{if(!s)return;const t=window.open("","_blank");t&&(t.document.write(`
        <!DOCTYPE html>
        <html>
          <head>
