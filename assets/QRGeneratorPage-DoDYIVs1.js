import{u as Q,r,j as e,aB as R,Q as l,i,a7 as A,V as S}from"./react-vendor-CLiifM8U.js";import{a as p}from"./index-DAo0lhFG.js";import{showError as c,showSuccess as u}from"./sweetalert-eWj-al0E.js";import"./export-libs-CrC4Cruk.js";import"./vendor-FPNzGmdA.js";import"./ui-libs-w2-9rgNc.js";function F(){const b=Q(),[x,m]=r.useState(!1),[y,j]=r.useState([]),[d,g]=r.useState(""),[s,h]=r.useState(null);r.useEffect(()=>{f()},[]);const f=async()=>{try{const a=await p().get("/assets"),n=Array.isArray(a.data)?a.data:a.data.assets||[];j(n)}catch(t){console.error("Failed to fetch assets:",t),await c("Error","Failed to load assets")}},w=async t=>{var a,n;if(t.preventDefault(),!d){await c("Error","Please select an asset");return}try{m(!0);const C=await p().post("/checkout/qr/generate",{assetId:d});h(C.data.qrCode),await u("Success!","QR code generated successfully",1500)}catch(o){console.error("Failed to generate QR code:",o),await c("Error",((n=(a=o.response)==null?void 0:a.data)==null?void 0:n.message)||"Failed to generate QR code")}finally{m(!1)}},k=()=>{if(!s)return;const t=document.createElement("a");t.href=s.qrCodeUrl,t.download=`QR_${s.asset.asset_code}.png`,document.body.appendChild(t),t.click(),document.body.removeChild(t),u("Downloaded!","QR code image downloaded",1500)},N=()=>{if(!s)return;const t=window.open("","_blank");t&&(t.document.write(`
        <!DOCTYPE html>
        <html>
          <head>
