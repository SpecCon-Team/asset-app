              ...
              <div className="p-6">
                ...
                <div className="flex gap-2 pt-4 border-t dark:border-gray-700">
                  <button
                    ...
                    className="flex-1 px-3 py-2 text-sm bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded hover:bg-blue-100 dark:hover:bg-blue-900/50 flex items-center justify-center gap-2 transition-colors"
                  >
                  ...
                  <button
                    ...
                    className="flex-1 px-3 py-2 text-sm bg-gray-50 dark:bg-gray-700 text-gray-600 dark:text-gray-300 rounded hover:bg-gray-100 dark:hover:bg-gray-600 flex items-center justify-center gap-2 transition-colors"
                  >
                  ...
                  <button
                    ...
                    className="px-3 py-2 text-sm bg-red-50 dark:bg-red-900/30 text-red-600 dark:text-red-400 rounded hover:bg-red-100 dark:hover:bg-red-900/50 flex items-center justify-center gap-2 transition-colors"
                  >
