...
export default function MyAssetsPage() {
  ...
  const myAssets = assets.filter((asset) => asset.assigned_to === userEmail);
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900 mt-2">{myAssets.length}</p>
              </div>
        ...
        {filteredAssets.length === 0 ? (
          <div className="bg-white rounded-lg shadow p-12 text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">
              {myAssets.length === 0 ? 'No assets assigned yet' : 'No assets found'}
            </h3>
            ...
            <div className="mt-4 text-sm text-gray-400">
              Debug Info: No assets found. Make sure an admin has assigned assets to your email ({userEmail}). 
